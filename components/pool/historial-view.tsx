...
export function HistorialView() {
  ...
  const exportJson = usePoolStore((s) => s.exportDataJson)
  const exportCsv = usePoolStore((s) => s.exportDataCsv)
  const exportTxt = usePoolStore((s) => s.exportDataTxt)
        ...
        return (
          <Card key={i} className="space-y-2 p-3">
            ...
            <div className="grid grid-cols-2 gap-1 text-xs text-muted-foreground">
              ...
              <span>
                Transparencia: {r.transparencia == null ? "—" : r.transparencia ? "Sí" : "No"}
              </span>
